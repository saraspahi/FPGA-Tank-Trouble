...
# Wed Nov 03 11:21:22 CDT 2021
# DO NOT MODIFY


# 
# VGA_text_mode_controller "VGA Text Mode Controller" v1.0
# Bleemsara 2021.11.03.11:21:22
# 
# 
...
add_fileset_file vga_text_avl_interface.sv SYSTEM_VERILOG PATH ../Lab7/vga_text_avl_interface.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL vga_text_avl_interface
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file vga_text_avl_interface.sv SYSTEM_VERILOG PATH ../Lab7/vga_text_avl_interface.sv
...
set_interface_property avl_mm_slave writeWaitStates 1
set_interface_property avl_mm_slave writeWaitTime 1
