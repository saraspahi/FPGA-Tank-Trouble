...
# Thu Dec 09 15:38:44 CST 2021
# DO NOT MODIFY


# 
# VGA_text_mode_controller "VGA Text Mode Controller" v1.0
# Bleemsara 2021.12.09.15:38:44
# 
# 
...
set_module_property AUTHOR Bleemsara
...
add_interface_port VGA_port blue new_signal Output 8
add_interface_port VGA_port green new_signal_1 Output 8
add_interface_port VGA_port hs new_signal_2 Output 1
add_interface_port VGA_port red new_signal_3 Output 8
...
set_interface_property keycode associatedClock CLK
...
add_interface_port keycode keycode_signal new_signal Input 32


# 
# connection point game_end
# 
add_interface game_end conduit end
set_interface_property game_end associatedClock CLK
set_interface_property game_end associatedReset ""
set_interface_property game_end ENABLED true
set_interface_property game_end EXPORT_OF ""
set_interface_property game_end PORT_NAME_MAP ""
set_interface_property game_end CMSIS_SVD_VARIABLES ""
set_interface_property game_end SVD_ADDRESS_GROUP ""

add_interface_port game_end game_end new_signal Output 2


# 
# connection point maze_ready
# 
add_interface maze_ready conduit end
set_interface_property maze_ready associatedClock CLK
set_interface_property maze_ready associatedReset ""
set_interface_property maze_ready ENABLED true
set_interface_property maze_ready EXPORT_OF ""
set_interface_property maze_ready PORT_NAME_MAP ""
set_interface_property maze_ready CMSIS_SVD_VARIABLES ""
set_interface_property maze_ready SVD_ADDRESS_GROUP ""

add_interface_port maze_ready maze_ready new_signal Input 1
...
add_interface_port game_reset game_reset new_signal Input 2


# 
# connection point spawn_pos
# 
add_interface spawn_pos conduit end
set_interface_property spawn_pos associatedClock CLK
set_interface_property spawn_pos associatedReset ""
set_interface_property spawn_pos ENABLED true
set_interface_property spawn_pos EXPORT_OF ""
set_interface_property spawn_pos PORT_NAME_MAP ""
set_interface_property spawn_pos CMSIS_SVD_VARIABLES ""
set_interface_property spawn_pos SVD_ADDRESS_GROUP ""

add_interface_port spawn_pos spawn_pos new_signal Input 20
